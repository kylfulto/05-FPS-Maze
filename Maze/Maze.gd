...
onready var Ketchup = preload("res://Ketchup/Ketchup.tscn")
...
func _ready():
	randomize()
	make_maze()
	var ketchup = Ketchup.instance()
	#ketchup.translation(Vector3(width*tile_size-1.5,0.5,1.5))
	add_child(ketchup)
	var exit = Exit.instance()
	#exit.translation(Vector3(width*tile_size-1.5,0.5,1.5))
	add_child(exit)
